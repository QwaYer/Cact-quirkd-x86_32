# Makefile for Cact quirkd (kernel-message logger daemon)
...
build/quirkd.o: main.c $(START_O) $(LIBC_SO)
	@mkdir -p build
	$(CC) $(CFLAGS) -c main.c -o $@

$(OUT): build/quirkd.o $(START_O) $(LIBC_SO)
	@mkdir -p build/sbin
	$(LD) $(LDFLAGS) $(START_O) build/quirkd.o $(LIBC_SO) -o $@

install: all
	@mkdir -p $(LR_SBIN)
	cp -f $(OUT) $(LR_SBIN)/quirkd
